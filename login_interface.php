...
<div class="login-box">
  ...
  <div class="card-body login-card-body">
    <p class="login-box-msg">Ingrese sus datos de inicio de sesión</p>
    ...
    <p class="mb-0">
      <span class="text-center">No tiene cuenta?</span>
      <a href="register_interface.php" class="text-center">Registrarse</a>
    </p>
  </div>
</div>
